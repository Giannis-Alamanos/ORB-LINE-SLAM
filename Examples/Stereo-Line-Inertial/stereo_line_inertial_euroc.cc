...
int main(int argc, char **argv)
{
    if(argc < 6)
    {
        cerr << endl << "Usage: ./stereo_inertial_line_euroc path_to_ORB_vocabulary path_to_Line_Vocabulary path_to_settings path_to_sequence_folder_1 path_to_times_file_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N path_to_times_file_N) " << endl;
        return 1;
    }
    ...
    ORB_SLAM3::System SLAM(argv[1],argv[2],argv[3],ORB_SLAM3::System::IMU_STEREO, true);
